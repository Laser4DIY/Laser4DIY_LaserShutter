...
![Laser4DIY Laser Shutter - 3D view](CAD/diagram_3d.PNG)
![Laser4DIY Laser Shutter - front view](CAD/diagram_front.PNG)
...
The laser shutter was designed for CO2 glass tube laser sources typically used in laser cutters, with a power of no more than 50W. The design includes a beam dump which takes up the laser power when the laser is active but the shutter is closed. The actual maximum power depends on how this block is cooled. Please add a heat sink or - even better - active cooling, depending on your requirements. The shutter lid itself is made of copper which has a high reflectivity at the wave length of ~10µm. For other wave lengths this is design cannot be used.
